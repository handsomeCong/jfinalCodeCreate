					...
					<div class="span12">
						<div class="box box-color box-bordered">
							...
							<div class="box-content nopadding">
								<form action="${contextpath}/zjbbsplate/saveAdd" method="POST" class='form-horizontal form-bordered form-validate' >
                                          ...
                                          <div class="controls">
											                                            <input type="date" class="input-medium" id="ctime" name="zjBbsPlate.ctime" placeholder="请输入创建时间" data-rule-required="true"/>
																					  </div>
                                        </div>
