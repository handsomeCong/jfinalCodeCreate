						...
						<div class="box box-color box-bordered">
							...
							<div class="box-content nopadding">
								<form action="${contextpath}/hydmemberbank/saveModify" method="POST" class='form-horizontal  form-bordered form-validate' >
																												...
																												<input type="hidden"  name="hydMemberBank.ID" value="${ model.ID}" id="ID"   />
									                                      																			                                        <div class="control-group">
                                          <label for="cardholder" class="control-label">持卡人：</label>
                                          <div class="controls">
											
																						   <input type="text" class="input-medium" id="cardholder" name="hydMemberBank.cardholder" value="${ model.cardholder}" data-rule-required="true"/>
                                          ...
                                          <div class="controls">
																						   ...
																						   <input type="text" class="input-medium" id="bank_name" name="hydMemberBank.bank_name" value="${ model.bank_name}" data-rule-required="true"/>
                                          ...
                                          <div class="controls">
																						   ...
																						   <input type="text" class="input-medium" id="bank_no" name="hydMemberBank.bank_no" value="${ model.bank_no}" data-rule-required="true"/>
                                          ...
                                          <div class="controls">
																						   ...
																						   <input type="text" class="input-medium" id="bank_sub_branch" name="hydMemberBank.bank_sub_branch" value="${ model.bank_sub_branch}" data-rule-required="true"/>
